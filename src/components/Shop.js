  ...
  return (
    <div style={divStyle}>
        ...
        <div className='d-flex just-evenly'>
            <h3 className='pointer' onClick={()=>setPage(true)}>Weapons</h3>
            <h3 className='pointer' onClick={()=>setPage(false)}>Potions</h3>
        </div>
        {page && <Weapons trader={trader}/>}
        {!page && <Potions trader={trader}/>}
        {page && <h3>Hover mouse over the weapon picture to get info about effects</h3>}
    </div>
)
};
